...
class _NnStreamChatLocalizationsDelegate
  ...
  @override
  bool isSupported(Locale locale) => locale.languageCode == 'sn';

  @override
  Future<StreamChatLocalizations> load(Locale locale) =>
      SynchronousFuture(SanoGanoStreamChatLocalizations());
...
/// and formatting.
class SanoGanoStreamChatLocalizations extends GlobalStreamChatLocalizations {
  /// Create an instance of the translation bundle for English.
  SanoGanoStreamChatLocalizations()
      : super(
          localeName: 'sn',
        );

  /// A [LocalizationsDelegate] for [SanoGanoStreamChatLocalizations].
  static const delegate = _NnStreamChatLocalizationsDelegate();

  @override
  String emojiMatchingQueryText(String query) {
    // TODO: implement emojiMatchingQueryText
    return "Emoji Matching";
  }
  ...
  @override
  // TODO: implement noPhotoOrVideoLabel
  String get noPhotoOrVideoLabel => throw UnimplementedError();
}
