...
class FollowersActivityTab extends StatelessWidget {
  FollowersActivityTab({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (activityController.detailedActivityList!.isEmpty) {
        ...
        List<DetailedNotificationModel>? followActivity = activityController
            .detailedActivityList!
            .where((element) => element.notificationModel.notificationBody!
                .contains('followed'))
            .toList();
          ...
          children: [
            ...List.generate(
                ...
                (index) => ActivityWidget(
                      notification: followActivity[index],
                    ))
          ],
