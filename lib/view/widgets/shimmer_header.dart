...
class ShimmerHeader extends RefreshIndicator {
  ...
  final Widget text;
  final Widget duringRefreshing;
  final Widget textCompleted;
  // final Widget textRefreshing;
  ...
  Widget buildContent(BuildContext context, RefreshStatus mode) {
    ...
    final Widget body = ScaleTransition(
      ...
      child: FadeTransition(
        ...
        child: mode == RefreshStatus.completed
            ? Center(
                child: widget.textCompleted,
              )
