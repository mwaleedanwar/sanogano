...
// import 'package:sano_gano/view/pages/chat/sendingScreen.dart';
// import 'package:sano_gano/view/pages/chat/stream_chat/new_chat_screen.dart';
// import 'package:sano_gano/view/pages/chat/stream_chat/routes/routes.dart';
...
// import 'package:sano_gano/view/widgets/post_shimmer.dart';
...
//                         child: buildPostMenuOptions(
//                             postModel!, postModel!.ownerId == currentUser.id,
...
//         future: widget.controller.isSaved(widget.postModel.postId),
//         builder: (context, snapshot) {
...
//                     Duration(seconds: 2), // <-- The debounce duration
//                     () => temp.value
//                         ? widget.controller.savePost(widget.postModel.postId)
//                         : widget.controller.unsavePost(
//                             widget.postModel.postId) // <-- The target method
//                     );
//                 // EasyDebounce.debounce(
//                 //     'save-debouncer', // <-- An ID for this particular debouncer
